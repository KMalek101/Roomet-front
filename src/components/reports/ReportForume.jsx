...
export default function ReportForum({ setShowReportForum }) {
  ...
  return (
    <div className="flex flex-col gap-4 bg-[var(--secondary-color)] p-6 py-2 rounded-md flex-1">
      ...
      {/*Rommate-related Issues*/}
      <div>
        <div
          onClick={() => setShowRommateRelatedIssues(!showRommateRelatedIssues)}
          className="flex gap-2 items-center cursor-pointer"
        >
          <h1 className="font-medium text-lg">Roomate-related Issues</h1>
          {ChevronDownIcon}
        </div>
        ...
        <label className="flex flex-col mt-8" > <p className="font-medium">Describe your issue : </p><textarea className="bg-[var(--g-color-opacity)] p-2 rounded-md focus:outline-1 focus:outline-[var(--green-color)]" name="" id=""></textarea></label>
      {/*Buttons*/}
